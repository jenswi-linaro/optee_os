...
struct mobj_spci *mobj_spci_new(unsigned int num_regions __unused,
...
uint32_t mobj_spci_add_region(struct mobj_spci *ms, unsigned int *idx,
...
uint32_t mobj_spci_register(struct mobj_spci *ms)
{
	uint32_t exceptions = 0;
